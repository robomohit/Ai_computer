...
<p align="center">
  <img src="docs/demo.gif" alt="A real run of Orynn driving the Windows Calculator while it is covered by another window the entire time — computing 2847 times 916 to get 2,607,852 — via UIA InvokePattern with no cursor movement, no screenshots, no pixel-clicking" width="380">
</p>

<p align="center"><sub>A real run: Orynn computes 2847 &times; 916 in the Windows Calculator <b>while it's covered by another window</b> — clicks go to the controls by name, the cursor never moves — on a free model, in 21 seconds.</sub></p>
