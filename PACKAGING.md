...
> install and *run*, not *read*. It's the same way you use Spotify or Discord
...
That installs the build tools and runs PyInstaller. When it finishes you'll have:
...
chromium` into the build. Most desktop-control + coding tasks don't need it.
...
PyInstaller hides the source well but isn't bulletproof. If you want the engine
...
Either can layer on top of this build when you're ready.
