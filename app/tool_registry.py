...
TOOL_DESCRIPTIONS = {
    ...
    ActionType.adaptive_observe: "adaptive_observe: {\"app\": str|null, \"cap\": int|null} - build a compact affordance graph for an unfamiliar Windows app/window: grouped UIA controls, likely text inputs, commands, menus, navigation targets, and an adaptive recovery plan if the app exposes no controls. Use before guessing names in complex apps or after any confusing miss.",
