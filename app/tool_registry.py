...
TOOL_PACKS = {
    ...
    "uia": [ActionType.uia_find, ActionType.uia_click, ActionType.uia_type, ActionType.uia_wait, ActionType.electron_check, ActionType.electron_unlock, ActionType.focus_window, ActionType.wait_for_window],
